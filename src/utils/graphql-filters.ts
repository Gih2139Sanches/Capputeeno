...
export function getFieldByPriority(priority: PriorityTypes){
    ...
    if(priority === PriorityTypes.BIGGEST_PRICE) return {field: "prince_in_cents", order: "ASC"}
    if(priority === PriorityTypes.MINOR_PRICE) return {field: "prince_in_cents", order: "ASC"}
